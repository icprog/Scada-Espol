////////////////////////////////////////////////////////////////////////////
//
// show_mask2 for ProcessViewServer created: jue feb 20 02:09:01 2014
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
enum {
  ID_MAIN_WIDGET = 0,
    ...
    label1,label2,usuario,pass,aceptar,ID_END_OF_WIDGETS
};
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,label1,ID_MAIN_WIDGET);
  pvSetGeometry(p,label1,380,180,66,17);
  pvSetFont(p,label1,"Ubuntu",11,0,0,0,0);
  pvSetText(p,label1,pvtr("Usuario"));


  pvQLabel(p,label2,ID_MAIN_WIDGET);
  pvSetGeometry(p,label2,355,210,76,17);
  pvSetFont(p,label2,"Ubuntu",11,0,0,0,0);
  pvSetText(p,label2,pvtr("Contraseña"));


  pvQLineEdit(p,usuario,ID_MAIN_WIDGET);
  pvSetGeometry(p,usuario,450,180,66,17);
  pvSetFont(p,usuario,"Ubuntu",11,0,0,0,0);
  pvSetText(p,usuario,pvtr(""));

  pvQLineEdit(p,pass,ID_MAIN_WIDGET);
  pvSetGeometry(p,pass,450,210,66,17);
  pvSetFont(p,pass,"Ubuntu",11,0,0,0,0);
  pvSetText(p,pass,pvtr(""));

  pvQPushButton(p,aceptar,ID_MAIN_WIDGET);
  pvSetGeometry(p,aceptar,450,250,66,17);
  pvSetFont(p,aceptar,"Ubuntu",11,0,0,0,0);
  pvSetText(p,aceptar,pvtr("Aceptar"));
  pvEndDefinition(p);
  return 0;
}
